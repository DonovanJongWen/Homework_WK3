...
function writePassword() {
  ...
  function promptChoices() {
    let passLength = parseInt(prompt("Please select the amount of character your password require \n Limit on Password characters are 8 and 128."));
  ...
  for (let i = 0; i < passLength; i++) {
    ...
    chosenCharArray = caseArray[randomArrayNum];

    randomCharNum = Math.floor(Math.random() * chosenCharArray.length);
